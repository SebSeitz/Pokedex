...
function createCard(name, image, weight, height, ability1, ability2, hp, attack, defense, specialAttack, specialDefense, speed, type, i, eggGroup, genus, captureRate, image2, image3) {
    ...
    <div class="deck" id="deck${i}" onclick="showCurrentCard(${i, name, image, weight, height, ability1, ability2, hp, attack, defense, specialAttack, specialDefense, speed, type, eggGroup, genus, captureRate})">
...
function showCurrentCard(i, name, image, weight, height, ability1, ability2, hp, attack, defense, specialAttack, specialDefense, speed, type, eggGroup, genus, captureRate){
    
   /* async function showCurrentCard(i) {
        let pokemon = await getPokemon(i);
        document.getElementById('wholeCard').innerHTML = createCard(...);
    } -->? Warum async function und wo soll ich Variable pokemon verwenden?*/
